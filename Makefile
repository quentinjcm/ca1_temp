...
DIST          = myRT.pro include/Triangle.hpp \
		...
		include/Film.hpp \
		include/Camera.hpp src/main.cpp \
		src/Triangle.cpp \
		src/TriangleMesh.cpp \
		src/Ray.cpp \
		src/BBox.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Triangle.hpp include/TriangleMesh.hpp include/Ray.hpp include/BBox.hpp include/Parser.hpp include/IsectData.hpp include/Film.hpp include/Camera.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/Triangle.cpp src/TriangleMesh.cpp src/Ray.cpp src/BBox.cpp src/Parser.cpp src/IsectData.cpp src/Film.cpp src/Camera.cpp $(DISTDIR)/
