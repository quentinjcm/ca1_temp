...
COMPRESS      = gzip -9f
DISTNAME      = myRT1.0.0
DISTDIR = /Users/quentin/ca1_temp/obj/myRT1.0.0
...
DIST          = myRT.pro include/Triangle.hpp \
		...
		include/Meshes.hpp \
		include/Renderer.hpp src/main.cpp \
		src/Triangle.cpp \
		src/TriangleMesh.cpp \
		src/Ray.cpp \
		src/BBox.cpp \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents include/Triangle.hpp include/TriangleMesh.hpp include/Ray.hpp include/BBox.hpp include/Parser.hpp include/IsectData.hpp include/Film.hpp include/Camera.hpp include/Primative.hpp include/GeometricPrim.hpp include/Meshes.hpp include/Renderer.hpp $(DISTDIR)/
	$(COPY_FILE) --parents src/main.cpp src/Triangle.cpp src/TriangleMesh.cpp src/Ray.cpp src/BBox.cpp src/Parser.cpp src/IsectData.cpp src/Film.cpp src/Camera.cpp src/Primative.cpp src/GeometricPrim.cpp src/Meshes.cpp src/Renderer.cpp $(DISTDIR)/
